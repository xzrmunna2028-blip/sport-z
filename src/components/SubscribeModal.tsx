...
export function SubscribeModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/60 p-4 backdrop-blur-md">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-emerald-400/40 bg-gradient-to-b from-[#0a1f15] to-[#04140d] p-6 shadow-[0_0_60px_rgba(16,185,129,.35)]">
